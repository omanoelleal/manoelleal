...
const skills = {
  "Languages & Query": ["Python", "SQL", "PySpark", "VBA"],
  "Cloud & Big Data": ["Google BigQuery", "Hadoop / HIVE", "ETL Pipelines"],
  "Visualization": ["Power BI", "OBIEE", "Dashboards"],
  "Tools & Platforms": ["Jira", "GitHub", "SSIS", "Power Automate", "SharePoint", "Power Apps"],
};

const education = [
  {
    degree: "MBA em Business Intelligence & Analytics",
    school: "Fundação Getulio Vargas (FGV)",
    year: "2019",
  },
  {
    degree: "Pós-Graduação em Banco de Dados",
        ...
        >
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div>
              ...
              <p className="text-cyan-400 font-medium mb-4">Data & Analytics Lead · Porto, Portugal</p>
              <p className="text-slate-300 leading-relaxed">
                With over 10 years of experience in Data Management, Business Intelligence and Big Data,
                I specialize in transforming complex datasets into strategic insights. Currently leading
                the Production & Analytics team at NOS SGPS, working with Google BigQuery, PySpark and Hadoop/HIVE clusters.
                I&apos;m passionate about automation, data quality and building solutions that drive business decisions.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {Object.entries(skills).map(([category, items]) => (
              ...
              >
                <h4 className="text-cyan-400 font-semibold mb-3 text-sm uppercase tracking-wider">{category}</h4>
            ...
            <div className="space-y-4">
              {education.map((edu) => (
                ...
                >
                  ...
                  <p className="text-cyan-400 text-sm mt-1">{edu.year}</p>
                </div>
              ))}
            </div>
          </motion.div>
